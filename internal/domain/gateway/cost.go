...
type Cost interface {
	...
	UpdateVariableExepense(ctx context.Context, id int, variableExepense entity.VariableExepense) error
	InsertCostCenter(ctx context.Context, costCenter entity.CostCenter) error
